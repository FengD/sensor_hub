...
#include "cyber/tools/cyber_visualizer/channel_reader.h"
#include "cyber/tools/cyber_visualizer/msg_dialog.h"
...
class MainWindow : public QMainWindow {
 ...
 private:
  ...
  CyberChannReader<crdc::airi::PointCloud2>* pointcloud_channel_Reader_;
