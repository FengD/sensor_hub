...
class RecordWriter : public RecordBase {
 public:
  ...
  void SetUseTimeNameFile(bool use_time_name_file) {
    use_time_name_file_ = use_time_name_file;
  }
  void SetOutPath(const std::string& out_path) {
    outpath_ = out_path;
  }
  void SetOutPrefix(const std::string& out_prefix) {
    outprefix_ = out_prefix;
  }
 ...
 private:
  ...
  bool use_time_name_file_ = false;
