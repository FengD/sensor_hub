...
PROTOBUF_NAMESPACE_OPEN
template<> ::crdc::airi::StatusPb* Arena::CreateMaybeMessage<::crdc::airi::StatusPb>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace crdc {
namespace airi {
...
enum ErrorCode : int {
  ...
  DRIVER_ERROR_LIDAR = 13000,
  DRIVER_ERROR_CAMERA = 14000,
  DRIVER_ERROR_RADAR = 15000,
  DRIVER_ERROR_IMU = 16000,
  STORYTELLING_ERROR = 17000
};
...
class StatusPb PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:crdc.airi.StatusPb) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:crdc.airi.StatusPb)
 private:
  class _Internal;
...
inline ::crdc::airi::ErrorCode StatusPb::_internal_error_code() const {
  return static_cast< ::crdc::airi::ErrorCode >(error_code_);
}
inline ::crdc::airi::ErrorCode StatusPb::error_code() const {
  // @@protoc_insertion_point(field_get:crdc.airi.StatusPb.error_code)
  return _internal_error_code();
}
inline void StatusPb::_internal_set_error_code(::crdc::airi::ErrorCode value) {
  assert(::crdc::airi::ErrorCode_IsValid(value));
  _has_bits_[0] |= 0x00000002u;
  error_code_ = value;
}
inline void StatusPb::set_error_code(::crdc::airi::ErrorCode value) {
  _internal_set_error_code(value);
  // @@protoc_insertion_point(field_set:crdc.airi.StatusPb.error_code)
}
...
inline const std::string& StatusPb::msg() const {
  // @@protoc_insertion_point(field_get:crdc.airi.StatusPb.msg)
  return _internal_msg();
}
inline void StatusPb::set_msg(const std::string& value) {
  _internal_set_msg(value);
  // @@protoc_insertion_point(field_set:crdc.airi.StatusPb.msg)
}
inline std::string* StatusPb::mutable_msg() {
  // @@protoc_insertion_point(field_mutable:crdc.airi.StatusPb.msg)
...
inline void StatusPb::set_msg(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:crdc.airi.StatusPb.msg)
}
inline void StatusPb::set_msg(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:crdc.airi.StatusPb.msg)
}
inline void StatusPb::set_msg(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000001u;
  ...
  // @@protoc_insertion_point(field_set_pointer:crdc.airi.StatusPb.msg)
}
...
inline std::string* StatusPb::release_msg() {
  // @@protoc_insertion_point(field_release:crdc.airi.StatusPb.msg)
...
inline void StatusPb::set_allocated_msg(std::string* msg) {
  ...
  msg_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), msg,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:crdc.airi.StatusPb.msg)
}
...
template <> struct is_proto_enum< ::crdc::airi::ErrorCode> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::crdc::airi::ErrorCode>() {
  return ::crdc::airi::ErrorCode_descriptor();
}
