...
class Header PROTOBUF_FINAL :
 ...
 public:
  ...
  enum : int {
    ...
    kInsTimestampFieldNumber = 10,
    kOtherTimestampFieldNumber = 11,
  ...
  // optional uint64 ins_timestamp = 10;
  bool has_ins_timestamp() const;
  private:
  bool _internal_has_ins_timestamp() const;
  public:
  void clear_ins_timestamp();
  ::PROTOBUF_NAMESPACE_ID::uint64 ins_timestamp() const;
  void set_ins_timestamp(::PROTOBUF_NAMESPACE_ID::uint64 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::uint64 _internal_ins_timestamp() const;
  void _internal_set_ins_timestamp(::PROTOBUF_NAMESPACE_ID::uint64 value);
  public:

  // optional uint64 other_timestamp = 11;
  bool has_other_timestamp() const;
  private:
  bool _internal_has_other_timestamp() const;
  public:
  void clear_other_timestamp();
  ::PROTOBUF_NAMESPACE_ID::uint64 other_timestamp() const;
  void set_other_timestamp(::PROTOBUF_NAMESPACE_ID::uint64 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::uint64 _internal_other_timestamp() const;
  void _internal_set_other_timestamp(::PROTOBUF_NAMESPACE_ID::uint64 value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::uint64 ins_timestamp_;
  ::PROTOBUF_NAMESPACE_ID::uint64 other_timestamp_;
...
// optional uint64 ins_timestamp = 10;
inline bool Header::_internal_has_ins_timestamp() const {
  bool value = (_has_bits_[0] & 0x00000080u) != 0;
  return value;
}
inline bool Header::has_ins_timestamp() const {
  return _internal_has_ins_timestamp();
}
inline void Header::clear_ins_timestamp() {
  ins_timestamp_ = PROTOBUF_ULONGLONG(0);
  _has_bits_[0] &= ~0x00000080u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 Header::_internal_ins_timestamp() const {
  return ins_timestamp_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 Header::ins_timestamp() const {
  // @@protoc_insertion_point(field_get:crdc.airi.Header.ins_timestamp)
  return _internal_ins_timestamp();
}
inline void Header::_internal_set_ins_timestamp(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _has_bits_[0] |= 0x00000080u;
  ins_timestamp_ = value;
}
inline void Header::set_ins_timestamp(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _internal_set_ins_timestamp(value);
  // @@protoc_insertion_point(field_set:crdc.airi.Header.ins_timestamp)
}

// optional uint64 other_timestamp = 11;
inline bool Header::_internal_has_other_timestamp() const {
  bool value = (_has_bits_[0] & 0x00000100u) != 0;
  return value;
}
inline bool Header::has_other_timestamp() const {
  return _internal_has_other_timestamp();
}
inline void Header::clear_other_timestamp() {
  other_timestamp_ = PROTOBUF_ULONGLONG(0);
  _has_bits_[0] &= ~0x00000100u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 Header::_internal_other_timestamp() const {
  return other_timestamp_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 Header::other_timestamp() const {
  // @@protoc_insertion_point(field_get:crdc.airi.Header.other_timestamp)
  return _internal_other_timestamp();
}
inline void Header::_internal_set_other_timestamp(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _has_bits_[0] |= 0x00000100u;
  other_timestamp_ = value;
}
inline void Header::set_other_timestamp(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _internal_set_other_timestamp(value);
  // @@protoc_insertion_point(field_set:crdc.airi.Header.other_timestamp)
}
